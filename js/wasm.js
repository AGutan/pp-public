...
(function( root, factory ) {
    ...
    const __imports = {
        env: {
            ...
            "__extjs_e5805f9b3f077bd194d48a332a8f7e739864eec3": function($0, $1) {
                $1 = Module.STDWEB.to_js($1);Module.STDWEB.from_js($0, (function(){return (($1)). getContext ("2d");})());
            },
            "__extjs_2e60b901e780e139bb6769562647a4c4f9ae0a54": function($0, $1, $2) {
                $1 = Module.STDWEB.to_js($1);$2 = Module.STDWEB.to_js($2);Module.STDWEB.from_js($0, (function(){(($1)). fillStyle = ($2);})());
            },
            "__extjs_f44649e7ec139a50f7308821851eb519a4103e22": function($0, $1, $2, $3) {
                $1 = Module.STDWEB.to_js($1);$2 = Module.STDWEB.to_js($2);$3 = Module.STDWEB.to_js($3);Module.STDWEB.from_js($0, (function(){(($1)). font = ($2)+ ($3);})());
            },
            "__extjs_9f0b0a60fb337c392d6f547d2e0591036816d885": function($0, $1, $2, $3, $4) {
                $1 = Module.STDWEB.to_js($1);$2 = Module.STDWEB.to_js($2);$3 = Module.STDWEB.to_js($3);$4 = Module.STDWEB.to_js($4);Module.STDWEB.from_js($0, (function(){(($1)). fillText (($2), ($3), ($4));})());
            },
            "__extjs_debaef281e504c25fab788a59033a5ee2144d8ce": function($0, $1, $2, $3, $4, $5) {
                $1 = Module.STDWEB.to_js($1);$2 = Module.STDWEB.to_js($2);$3 = Module.STDWEB.to_js($3);$4 = Module.STDWEB.to_js($4);$5 = Module.STDWEB.to_js($5);Module.STDWEB.from_js($0, (function(){(($1)). fillRect (($2), ($3), ($4), ($5));})());
            },
            "__extjs_ba225a747f9c507cf2fdc1df0aa61fdfff79d0f2": function($0, $1, $2) {
                $1 = Module.STDWEB.to_js($1);$2 = Module.STDWEB.to_js($2);Module.STDWEB.from_js($0, (function(){(($1)). shadowColor = "rgb(140, 255, 170)" ; (($2)). shadowBlur = 8 ;})());
            },
            ...
            "__extjs_a332aea7641dfb41a916dcd46c0afb29196c78ca": function($0) {
                Module.STDWEB.from_js($0, (function(){return window.innerHeight ;})());
            },
            "__extjs_213e69e09253cf0be39d4141695c8437e8086a47": function($0) {
    ...
    function __load( instance ) {
        ...
        if( typeof module !== 'undefined' && module.exports ) {
            ...
            Rust.wasm.exports = Module.exports;
        }
    ...
    if( Module.nodejs ) {
        ...
        const wasm_path = path.join( __dirname, "js/wasm.wasm" );
        ...
        const __promise = fetch( "js/wasm.wasm" )
            .then( response => response.arrayBuffer() )
            .then( bytes => WebAssembly.instantiate( bytes, __imports ) )
            .then( results => {
                __load( results.instance );
                console.log( "Finished loading Rust wasm module 'wasm'" );
                return Module.exports;
            })
            .catch( error => {
                console.log( "Error loading Rust wasm module 'wasm':", error );
                throw error;
            });
